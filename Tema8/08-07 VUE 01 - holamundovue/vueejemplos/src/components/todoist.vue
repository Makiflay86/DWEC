<template>
    <div class="task-list">
        ...
        <form class="form" @submit.prevent="createTask">
            ...
            <input class="button" type="button" value="Eliminar último" @click="eliminarUltimo" />
            <input class="button" type="button" value="Eliminar caja" @click="eliminarCaja" />
        </form>
